...
class ImageSegUI(UI):
        ...
        with gr.Blocks() as demo:
            ...
            with gr.Tabs():
                with gr.Tab("1st Step - SAM"):
                    sam_display, instruction = self.ui_SAM(mask_dir_field, input_image, image_index_slider)
            ...
            image_index_slider.change(self.update_img_index_event, [image_index_slider], [input_image, sam_display, instruction])

        return demo


    def ui_SAM(self, mask_dir_field, input_image, image_index_slider):        
        with gr.Row():
            with gr.Column():
    ...
    def update_img_index_event(self, img_index):
        ...
        return input_image, output_img, message
